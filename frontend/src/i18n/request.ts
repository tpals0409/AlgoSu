...
/** 지원하는 번역 네임스페이스 목록 */
const NAMESPACES = ['common', 'landing', 'auth', 'difficulty', 'errors', 'dashboard', 'problems', 'submissions', 'reviews', 'account', 'layout', 'analytics', 'feedback', 'ui', 'studies', 'admin', 'sharing', 'legal', 'quiz'] as const;
