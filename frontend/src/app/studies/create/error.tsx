...
export default function StudyCreateErrorPage({ reset }: ErrorPageProps): ReactNode {
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-bg px-4">
      <h1 className="text-4xl font-bold text-text">스터디 생성 오류</h1>
      <p className="mt-4 text-sm text-text-3">
        스터디 생성 페이지를 불러올 수 없습니다.
      </p>
