...
export default function ProblemStatusErrorPage({ reset }: ErrorPageProps): ReactNode {
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-bg px-4">
      <h1 className="text-4xl font-bold text-text">제출 현황 오류</h1>
      <p className="mt-4 text-sm text-text-3">
        문제 제출 현황을 불러올 수 없습니다.
      </p>
