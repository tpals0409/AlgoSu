-- =========================================================================
-- AlgoSu Demo Seed Data — submission_db
-- =========================================================================
-- @file demo-seed-submission.sql
-- @domain infra
-- @layer seed
-- @related demo-seed-identity.sql, demo-seed-problem.sql, infra/k3s/demo-reset-cronjob.yaml
--
-- 목적: 데모 환경 submission_db 시드 (submissions, review_comments, study_notes)
-- 대상 DB: submission_db (postgres.algosu.svc.cluster.local)
-- 실행: psql -U algosu_admin -d submission_db -f demo-seed-submission.sql
