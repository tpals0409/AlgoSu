...
| **GitHub / 인증** | [github-token-relink](./runbook/github-token-relink.md) · [pat-rotation](./runbook/pat-rotation.md) · [key-rotation](./runbook/key-rotation.md) · [encryption-key-rotation](./runbook/encryption-key-rotation.md) · [admin-emails](./runbook/admin-emails.md) |
...
| **관측성 / 모니터링** | [oncall-alerts](./runbook/oncall-alerts.md) · [alert-channel-separation](./runbook/alert-channel-separation.md) · [dlq-redrive](./runbook/dlq-redrive.md) |
