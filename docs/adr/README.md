...
└─ sprints/
   └─ sprint-{NN}.md                      ← 회고형 sprint ADR (129개, Sprint 62~191 일부 결번 + 통합 40·48·51)
```
...
`sprints/sprint-{NN}.md` — Sprint 62 ~ 191 매 sprint 회고. 신규 sprint 종료 시 `/stop` 워크플로우가 자동 생성/갱신 (KR + EN 동시 작성).
