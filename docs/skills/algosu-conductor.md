...
### StudyMemberGuard 에러 메시지 통일 규칙 (2026-03-03 확정)
...
- **완료**: UI-2(isLate), UI-3(제출 UI Monaco), UI-5(review_comments/replies/study_notes), 3-1(Problem DB)
- **핵심 변경**: UUID publicId, httpOnly Cookie JWT, ExceptionFilter, review 테이블 3종 추가
