...
order: 2
tldr: "AlgoSu를 왜 MSA로 나눴고 서비스 경계·통신·인증·배포를 누가 어떻게 결정했는지. 제출 한 건의 여정으로 전체 아키텍처를 조망한다."
relatedAdrs: ["ADR-001", "ADR-002", "ADR-003"]
---

<Problem label="문제">
혼자 만드는 서비스를 왜 굳이 여러 개로 쪼갰나 — MSA의 출발점.
</Problem>
...
<Decision label="결정">
서비스 경계·통신·인증·배포를 사람이 결정하고 AI가 실행하게 나눴다.
</Decision>
...
<Result label="결과">
설계의 경계 — 무엇을 사람이 정하고 무엇을 AI에게 맡겼나.
</Result>
