...
category: ai-agent
order: 3
tldr: "To govern 12 AI agents, I built a governance structure: a single Oracle channel, a 3-Echelon hierarchy, and persona-base.md as the SSoT. It delivered consistent code quality — but context cost and the Oracle bottleneck remained as trade-offs."
relatedAdrs: ["sprint-82", "sprint-116", "sprint-114"]
---
...
Narrow the channel to one, split agents into priority tiers, and gather shared rules into a single file — a single Oracle channel, a 3-Echelon hierarchy, and persona-base.md as SSoT.
</Decision>
...
<Result label="Result">
What 67 sprints under this structure gained — and lost: consistent quality, but context cost and an Oracle bottleneck remained.
</Result>
