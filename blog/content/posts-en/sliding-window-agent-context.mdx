...
category: challenge
order: 10
tldr: "Across 152 sprints, the ADRs, MEMORY, and CLAUDE.md swelled together and ate into context. A record of optimizing agent context with the sliding window algorithm — and hitting seven sprints in a row without regression."
...
The growing pile of docs began eating the agent's context every session — like pouring water into an already-full bucket.
</Problem>
