...
order: 2
tldr: "Why AlgoSu was split into an MSA, and who decided the service boundaries, communication, auth, and deployment. A look at the whole architecture through the journey of a single submission."
relatedAdrs: ["ADR-001", "ADR-002", "ADR-003"]
---

<Problem label="Problem">
Why split a solo-built service into many pieces at all — the starting point of MSA.
</Problem>
...
Service boundaries, communication, auth, and deployment — humans decided, AI executed.
</Decision>
...
<Result label="Result">
The boundaries of design — what humans set, and what was left to AI.
</Result>
