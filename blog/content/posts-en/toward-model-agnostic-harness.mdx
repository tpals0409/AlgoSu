...
category: challenge
order: 9
tldr: "I placed a Codex-based Critic as an addition, not a replacement, in the pre-merge seat. Across 17 rounds of cross-review I even found bias in the harness itself — a record of moving toward a model-agnostic harness."
relatedAdrs: ["sprint-114", "sprint-117", "sprint-136"]
---
...
A harness leaning on a single model needed another perspective — but what to bring in, and how, was the question.
</Problem>
...
I decided to add a Codex-based Critic — not as a replacement — in the pre-merge seat.
</Decision>
...
In Sprint 95~97, I cut Baekjoon Online Judge dependency and migrated to Programmers — [When Baekjoon Vanished](/en/posts/baekjoon-gone). The cost of dependency was something I had already experienced firsthand back then.
</Callout>
...
<Result label="Result">
Finding the limits of the Critic and bias in the harness itself, arriving at a model-agnostic harness.
</Result>
