...
category: challenge
order: 7
tldr: "When Baekjoon — an external dependency — became unavailable, I migrated AlgoSu's problem source to Programmers over three sprints. It left lessons every externally-dependent service should remember."
relatedAdrs: ["sprint-95", "sprint-97"]
---
...
AlgoSu leaned on an external platform for its problems — and the day that dependency broke arrived.
</Problem>
...
I decided to migrate the problem source to Programmers over three sprints.
</Decision>
...
<Result label="Result">
What the migration achieved, and what externally-dependent services must never forget.
</Result>
