...
category: journey
order: 5
tldr: "A project that began from curiosity about multi-agent systems became a full platform over 67 sprints. A retrospective on good decisions, deferred ones, and the shift from coder to builder."
relatedAdrs: ["ADR-001", "ADR-002", "ADR-026"]
---
...
Some things only became visible after finishing 67 sprints firsthand.
</Problem>
...
<DecisionBridge
  fromSprint={12}
  fromLabel="Split into 3 databases"
  toSprint={51}
  toLabel="Full Gateway DB separation"
  insight="40 sprints later, overengineering saved the day"
  accent={3}
/>
...
<DecisionBridge
  fromSprint={8}
  fromLabel="Adopted httpOnly Cookies"
  toSprint={65}
  toLabel="Removed 11 localStorage functions"
  insight="57 sprints later, zero tech debt"
  accent={1}
/>
...
<MetricGrid cols={3}>
  <MetricCard label="Total Sprints" value="67" hint="Sprint 3 – 67" accent={1} />
  <MetricCard label="Total Tests" value="2,432" hint="Identity branches 99.51%" accent={2} />
  <MetricCard label="CI Jobs" value="15" accent={3} />
  <MetricCard label="Microservices" value="6" hint="Gateway · Identity · Submission · Problem · GitHub-Worker · AI-Analysis" accent={4} />
  <MetricCard label="AI Agents" value="12" hint="Oracle + 11" accent={5} />
  <MetricCard label="Identity API" value="34" hint="0 → 34 in Sprint 51" accent={6} />
</MetricGrid>

---

<Result label="Result">
What 67 sprints left behind — the shift from coder to builder.
</Result>
...
<Callout type="success" title="Things you only gain by doing">
The instinct for operating AI agents like teammates, the habit of weaving safety nets with 15 CI jobs, the experiential conviction that "the design that felt excessive turned out to be right" — these can't be learned from documentation. They only come from doing.
</Callout>
