 ...
 *
 * 영구 ADR 상세 페이지 — /adr/permanent/:id 경로.
 */
...
/** 영구 ADR 상세 페이지를 렌더링한다. */
export default async function PermanentDetailPage({ params }: Props) {
  ...
  return <AdrDetailView doc={doc} miniGraph={miniGraph} />;
}
