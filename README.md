...
<!-- 스크린샷 추가 예정: 데모 로그인 → 스터디룸 → AI 분석 결과 -->

| 항목 | 내용 |
|------|------|
| URL | [algo-su.com/login](https://algo-su.com/login) |
| 방법 | 로그인 페이지에서 **"데모로 체험하기"** 버튼 클릭 |
| 제한 | 읽기 전용 — 생성/수정/삭제(CUD) 작업 차단 |
| 리셋 | 6시간 주기 자동 초기화 (CronJob) |

> 데모 환경에는 알고리즘 문제 6개, 제출 15건, AI 분석 결과가 미리 세팅되어 있습니다.
