...
│   └── src/
│       ├── app/        # 페이지 (20+ 라우트)
│       ├── components/ # UI 컴포넌트 (ui/ 22종 + layout/ + review/ + submission/ + landing/)
...
├── infra/
│   ├── k3s/            # k8s 매니페스트 (18개 YAML + kustomization)
...
├── scripts/            # deploy.sh, e2e-jwt-payload.sh
...
- **CSS 변수**: 47개 듀얼 테마 토큰 (globals.css)
