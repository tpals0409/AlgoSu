/**
 * @file users 테이블에 publicId UUID v4 컬럼 추가
 * @domain identity
 * @layer migration
 * @related User
 *
...
export class AddPublicIdToUsers1709000001000 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `UPDATE "users" SET "publicId" = gen_random_uuid() WHERE "publicId" IS NULL`,
    );
    ...
    await queryRunner.query(
      `CREATE UNIQUE INDEX CONCURRENTLY "IDX_users_publicId" ON "users" ("publicId")`,
    );
